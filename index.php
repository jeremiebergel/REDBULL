...
<div class="container-background">
	<main>
		<div class="wrapper">
			...
			<p>Gagne ton vélo et ton ticket pour les</p>
			<h3>X Games-Minneapolis</h3>
			<p class="date">13-16 juillet 2017</p>
			<p class="cta"><a href="#">C'est parti !</a></p>
		</div>
    ...
    <div class="wrapper-popup-concours closed">
        <div class="popup-concours">
            ...
            <div class="lots">
                ...
                <ul>
                    <li class="clearfix">
                        <p class="color-red">1<sup>er</sup></p>
                        <p>Un voyage pour les XGAMES et ton vélo customisé</p>
                    </li>
                    <li class="clearfix">
                        <p class="color-red">2<sup>e</sup></p>
                        <p>Ton vélo customisé et un drone</p>
                    </li>
                    <li class="clearfix">
                        <p class="color-red">3<sup>e</sup></p>
	...
	<div class="wrapper-popup creation-acc closed">
		<div class="popup creat-acc">
			<img src="img/logo-black.png" alt="">
			<img class="cross" src="img/cross.svg">
			<p class="create">Créez votre compte</p>
			...
			<a class="social connect" href="config.php">
				<p>Connexion</p>
			</a>
    ...
    <div class="wrapper-popup closed">
        <div class="popup">
            <img src="img/logo-black.png" alt="">
            <img class="cross" src="img/cross.svg">
            <p class="create">Connectez vous à votre compte</p>
            <input type="email" placeholder="E-mail">
